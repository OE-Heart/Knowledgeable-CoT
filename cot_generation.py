...
def get_instruct_result(problems, shot_qids, test_qid, args):
    ...
    prompt_input.build_prompt(prompt=test_example,
    ...
    # generate prediction
    output = prompt_input.get_openai_result(engine=args.engine,
...
def parse_args():
    ...
    parser.add_argument('--visual_clues_file', type=str, default='data/visual_clues.json')
    ...
    parser.add_argument('--use_visual_clues', action='store_true', help='Use visual clues or not')
    parser.add_argument('--multiple_api_keys', action='store_true', help='Use multiple API keys')
    ...
    parser.add_argument('--n_shots', type=int, default=2, help='Number of n-shot training examples.')
